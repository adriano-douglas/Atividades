...
public class TelaInicial extends JFrame {
	...
	public TelaInicial(CadastroFuncionarioPanel _cadastroFuncionarioPanel, CadastroClientePanel _cadastroClientePanel,
		...
		mnCadastros.setIcon(new ImageIcon("src\\Trabalho_Etapa2_POO_AdrianoRosa\\imagens\\cadastro.png"));
		...
		mnCadFunc.setIcon(new ImageIcon("src\\Trabalho_Etapa2_POO_AdrianoRosa\\imagens\\funcionario.png"));
		...
		mnCadCliente.setIcon(new ImageIcon("src\\Trabalho_Etapa2_POO_AdrianoRosa\\imagens\\cliente.png"));
		...
		mnPedidos.setIcon(new ImageIcon("src\\Trabalho_Etapa2_POO_AdrianoRosa\\imagens\\pedido.png"));
		...
		mnPedidosNovo.setIcon(new ImageIcon("src\\Trabalho_Etapa2_POO_AdrianoRosa\\imagens\\adicionar.png"));
		mnPedidosNovo.setBackground(new Color(255, 255, 240));
		mnPedidos.add(mnPedidosNovo);

		mnPedidosVisualizar = new JMenuItem("Visualizar");
		mnPedidosVisualizar.setIcon(new ImageIcon("src\\Trabalho_Etapa2_POO_AdrianoRosa\\imagens\\pesquisar-arquivo.png"));
		...
		mnSair.setIcon(new ImageIcon("src\\Trabalho_Etapa2_POO_AdrianoRosa\\imagens\\sair.png"));
		...
		lblImagemInfo.setIcon(new ImageIcon("src\\Trabalho_Etapa2_POO_AdrianoRosa\\imagens\\lanchonete.png"));

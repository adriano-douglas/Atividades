...
public class CadastroAnimalView extends JPanel {
	...
	private static JTextField textIdAnimal, textNomeAnimal, textIdadeAnimal, textRacaAnimal, textCorAnimal, textPesoAnimal, textNumeroAnilhaAnimal;
	...
	public CadastroAnimalView() {
		...
		direitaPanel.add(labelProprietario);
		direitaPanel.add(comboProprietarios);
	...
	public ProprietarioModel getProprietarioSelecionado() {
		if((ProprietarioModel) comboProprietarios.getSelectedItem() instanceof ProprietarioModel) {

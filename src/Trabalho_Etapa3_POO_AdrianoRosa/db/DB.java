package Trabalho_Etapa3_POO_AdrianoRosa.db;
...
import Trabalho_Etapa3_POO_AdrianoRosa.dao.LancheDao;
...
public abstract class DB {
	...
	public static ArrayList<Pizza> pizzasPersonalizadas = new ArrayList<>();
	...
	public static void carregarDados() {
		molhosPizza = ItensPizzaDao.buscarTodosMolhosPizza();
		recheiosPizza = ItensPizzaDao.buscarTodosRecheiosPizza();
		recheiosBordaPizza = ItensPizzaDao.buscarTodosRecheiosBorda();
		clientes = ClienteDao.buscarTodosClientes();
		funcionarios = FuncionarioDao.buscarTodosFuncionarios();
		lanches = LancheDao.buscarTodosLanches();
		salgadinhos = SalgadinhoDao.buscarTodosSalgadinhos();
		pizzas = PizzaDao.buscarTodasPizzas(false);
		pizzasPersonalizadas = PizzaDao.buscarTodasPizzas(true);
		pedidos = PedidoDao.buscarTodosPedidos();
		pagamentos = PagamentoDao.buscarTodosPagamentos();
	}
	...
	public static Molho buscarMolhoPizzaPorId(Integer id) {
	...
	public static Recheio buscarRecheioBordaPorId(Integer id) {
	...
	public static Recheio buscarRecheioPizzaPorId(Integer id) {
	...
	public static Funcionario buscarFuncionarioPorId(Integer id) {
	...
	public static Prato buscarPratoPorId(Integer id) {
		for(Pizza p : pizzas) {
		...
		for(Pizza p : pizzasPersonalizadas) {
			if(p.getId().equals(id)) return p;
		}
		return null;
	}
	
	public static Pedido buscarPedidoPorId(Integer id) {
	...
	public static Pagamento buscarPagamentoPorId(Integer id) {
